...
public class SteamManager : MonoBehaviour {
	...
	protected virtual void Awake() {
		...
		// TODO: Steam Manager destroy disabled here to work with my own scripts
		...
		if (!m_bInitialized) {
			...
			Debug.LogWarning("<color=lime>SteamAPI not initialized. Steam likely not running.</color>", this);
			return;
		}
